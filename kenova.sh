#!/bin/bash
# - title        : kenova
# - description  : This script will assist in the use of the python-novaclient
# - author       : Kevin Carter
# - date         : 2012-06-05
# - version      : 1.4
# - License      : GPLv3
...
export OS_USERNAME OS_REGION_NAME OS_AUTH_SYSTEM NOVA_RAX_AUTH OS_PASSWORD OS_AUTH_URL NOVA_VERSION NOVA_SERVICE_NAME OS_TENANT_NAME NOVA_REGION_NAME
# This is a sanity check to make sure you have listed a function
if [ ! -z $3 ];then
    $NOVA $3 $4 $5 $6 $7 $8 $9;
    # if no function was listed go will let you know and then show the help screen
